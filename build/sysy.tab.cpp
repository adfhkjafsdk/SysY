...
#line 38 "lv1/sysy.y"
            {
	ast = std::unique_ptr<std::string>((yyvsp[0].str_val));
  }
#line 1084 "build/sysy.tab.cpp"
    break;

  case 3: /* FuncDef: FuncType IDENT '(' ')' Block  */
#line 44 "lv1/sysy.y"
                                       {
		auto type = std::unique_ptr<std::string>((yyvsp[-4].str_val));
		auto ident = std::unique_ptr<std::string>((yyvsp[-3].str_val));
		auto block = std::unique_ptr<std::string>((yyvsp[0].str_val));
		(yyval.str_val) = new std::string(*type + " " +  *ident + "() " + *block); 
	}
#line 1095 "build/sysy.tab.cpp"
    break;
...
#line 1103 "build/sysy.tab.cpp"
    break;

  case 5: /* Block: '{' Stmt '}'  */
#line 59 "lv1/sysy.y"
                       {
		auto stmt = std::unique_ptr<std::string>((yyvsp[-1].str_val));
		(yyval.str_val) = new std::string("{ " + *stmt + " }");
	}
#line 1112 "build/sysy.tab.cpp"
    break;

  case 6: /* Stmt: RETURN Number ';'  */
#line 66 "lv1/sysy.y"
                            {
		auto val = std::unique_ptr<std::string>((yyvsp[-1].str_val));
		(yyval.str_val) = new std::string("return " + *val + ";");
	}
#line 1121 "build/sysy.tab.cpp"
    break;

  case 7: /* Number: INT_CONST  */
#line 72 "lv1/sysy.y"
                    {
		(yyval.str_val) = new std::string(std::to_string((yyvsp[0].int_val)));
	}
#line 1129 "build/sysy.tab.cpp"
    break;


#line 1133 "build/sysy.tab.cpp"
