...
enum SymbolDefTag { SDT_EXPR, SDT_LOAD, SDT_ALLOC, SDT_FUNCALL };
			...
			case ST_SYMDEF:
				...
				switch(symdef.tag) {
					...
					case SDT_ALLOC:
						...
						break;
					case SDT_FUNCALL:
						delete symdef.func.fun;
						for(auto p: *symdef.func.para) delete p;
						delete symdef.func.para;
						break;
				}
				break;
			case ST_RETURN:
				if(ret.val != nullptr) delete ret.val;
				break;
			case ST_STORE:
